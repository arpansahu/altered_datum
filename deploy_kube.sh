...
LOCAL_IMAGE="altered_datum"
TAG="latest"
NAMESPACE="default"
SECRET_NAME="altered-datum-secret"
ENV_FILE=".env"
...
function set_default_variables {
    IMAGE_NAME="altered_datum"
    KUBE_DEPLOYMENT="altered-datum-app"
    DEPLOYMENT_FILE="deployment.yaml"
}

# Function to set mac specific variables
function set_mac_variables {
    IMAGE_NAME="altered_datum_mac"
    KUBE_DEPLOYMENT="altered-datum-mac-app"
